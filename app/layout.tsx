  ...
  return (
    <html lang="ru" suppressHydrationWarning className={`overflow-x-hidden ${roboto.variable}`}>
      <head>
        ...
        <link rel="preload" href="/gallery/background1_2.png" as="image" fetchPriority="high" />
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=109407571', 'ym');
              ym(109407571, 'init', {webvisor:true, clickmap:true, trackLinks:true, accurateTrackBounce:true});
            `
          }}
        />
        <noscript><div><img src="https://mc.yandex.ru/watch/109407571" style={{ position: 'absolute', left: '-9999px' }} alt="" /></div></noscript>
