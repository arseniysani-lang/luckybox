  ...
  return (
    <main className="min-h-screen bg-neutral-50 relative">
      ...
      <motion.button
        ...
        onClick={scrollToTop}
        className="fixed bottom-6 md:bottom-8 left-6 md:left-8 z-50 bg-gold-200 p-3 md:p-4 rounded-full shadow-lg hover:bg-gold-300 transition-all duration-300 cursor-pointer"
